...
%             disp("Gráfico de señal preprocesada")
...
%             nTrial = input("Ingrese el número de la prueba (1-25):\n");       
            ...
            sTrial = tSubject*(E.nSubject-1)+tSession*(E.nSession-1)+E.nTrial;

            signal = trials{sTrial}.signal;
            Tm = 1/128;
            t = 0:Tm:(size(trials{sTrial}.signal,2)-1)*Tm;
            ...
            set(gca, 'YTick',yt, 'YTickLabel',ChC(1:end))                     % Set Tick Labels
            title('Señal preprocesada')
            end
            % ------------------ Fin Gráfico ---------------------
...
%             disp("Gráfico de extracción de caracteristicas")
%             nSubject = input("Ingrese el número del sujeto (1-11):\n");
%             nSession = input("Ingrese el número de la sesión (1-5):\n");
%             nTrial = input("Ingrese el número de la prueba (1-25):\n"); 
            sTrial = tSubject*(E.nSubject-1)+tSession*(E.nSession-1)+E.nTrial;
            ...
            switch E.evalMethod
                ...
                case E.EVAL_METHOD_LOSO
                    ...
                    if isa(E.classification,'eegtoolkit.classification.LIBSVMFast')
                        instanceSet.K = instanceSet.computeKernel(E.classification.kernel, ...
                            E.classification.gamma,E.classification.maxlag,E.classification.scaleopt);
                    end
